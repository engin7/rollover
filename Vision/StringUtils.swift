...
extension String {
    ...
    func extractPhoneNumber() -> (Range<String.Index>, String, [String])? {
        ...
        guard phoneNumberDigits.count == 12 else {
            return nil
        }
        ...
        for var char in phoneNumberDigits {
            ...
            if even%2 == 0 && flag{
                numbers.append(String(resultDummy))
                result.append(" ")
                resultDummy = ""
            }
            even += 1
